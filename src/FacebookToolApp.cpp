#include <new>
#include "FacebookToolApp.h"
#include "FacebookToolFrame.h"

using namespace Tizen::App;
using namespace Tizen::System;

FacebookToolApp::FacebookToolApp(void)
{
}
...
UiApp*
FacebookToolApp::CreateInstance(void)
{
	// TODO: Create the application instance through the constructor.
	return new (std::nothrow) FacebookToolApp();
}

bool
FacebookToolApp::OnAppInitializing(AppRegistry& appRegistry)
{
...
bool
FacebookToolApp::OnAppInitialized(void)
{
	// TODO: Create the application frame.

	FacebookToolFrame* pFacebookToolFrame = new (std::nothrow) FacebookToolFrame;
	TryReturn(pFacebookToolFrame != null, false, "The memory is insufficient.");
	pFacebookToolFrame->Construct();
	pFacebookToolFrame->SetName(L"FacebookTool");
	AddFrame(*pFacebookToolFrame);

	return true;
}

bool
FacebookToolApp::OnAppWillTerminate(void)
{
...
bool
FacebookToolApp::OnAppTerminating(AppRegistry& appRegistry, bool forcedTermination)
{
...
void
FacebookToolApp::OnScreenOn(void)
{
...
void
FacebookToolApp::OnScreenOff(void)
{
