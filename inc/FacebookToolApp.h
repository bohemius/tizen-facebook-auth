#ifndef _FACEBOOK_TOOL_APP_H_
#define _FACEBOOK_TOOL_APP_H_
...
//  The [FacebookTool]App class must inherit from the UiApp class,
...
public:
	...
	FacebookToolApp(void);
	virtual ~FacebookToolApp(void);
